...
1. Objective
1.	Understand patterns in global billionaire distribution.
2.	Identify key factors associated with high net worth.
3.	Build and compare predictive models for billionaire net worth.
2. Introduction
